...
public class HelloController implements Initializable {
    ...
    private void personalizarBotones() {
        menuComunicaDefecto.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("comunicar1.png"))));
        menuComunicaDefecto.setAccelerator(new KeyCodeCombination(KeyCode.D, KeyCombination.CONTROL_DOWN));
        menuComunicarEspecifico.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("comunicar2.png"))));
